                    ...
                    <div class="wow fadeInUp a3r aH[500px] a1X a1C a2l[#f5f5f5] a1 a2P dark:a4E dark:a3 sm:a4j[60px]" data-wow-delay="0s">
                        ...
                        <form method="POST">
                            <div class="a2n">
                                ...
                                <input type="number" name="otp" placeholder="Enter Recevied OTP" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" required />
                            </div>
                            <div class="a2a">
                                <button name="submit" class="hover:a38 aa ab ac a1t a1u a1A al a4K a1F a1R aT a3d a1c a4L hover:a4">
                                    Verify OTP
                                </button>
                            </div>
                        </form>
