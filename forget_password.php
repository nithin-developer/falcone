...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Falcone`s Verification Code';
    $mail->Body    = "Hello!, Your Verification code to Reset your Password is <br><br> <h2>$otp</h2>";
    ...
    echo "<script>alert('Message could not be sent! Mail Server Error')</script>";
  }
}
?>
          ...
          <div class="wow fadeInUp a3r aH[500px] a1X a1C a2l[#f5f5f5] a1 a2P dark:a4E dark:a3 sm:a4j[60px]" data-wow-delay="0s">
            ...
            <form method="POST">
              <div class="a2n">
                ...
                <input type="email" name="email" placeholder="Enter your Email" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" />
              </div>
              <div class="a2a">
