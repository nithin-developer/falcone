...
if (isset($_POST['submit'])) {
    ...
    if ($pass == $cpass) {
        $connect = mysqli_connect('localhost', 'root', '', 'falcone');

        $sql = "UPDATE users SET Password = '$pass' WHERE Email = '$email'";
        $update = mysqli_query($connect, $sql) or die("database error:" . mysqli_error($connect));

        if (!$update) {
            echo "<script>alert('Somethig Went Wrong!, Email not Registered')</script>";
        } else {
...
<body x-data="
    ...
    <section class="af a2E a1J[180px] a4D[120px]" style="margin-top: -40px;">
        <div class="ae">
                    ...
                    <div class="wow fadeInUp a3r aH[500px] a1X a1C a2l[#f5f5f5] a1 a2P dark:a4E dark:a3 sm:a4j[60px]" data-wow-delay="0s">
                        ...
                        <form method="POST">
                            <div class="a2n">
                                ...
                                <input type="password" name="pass" placeholder="Enter Password" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" />
                            </div>
                            <div class="a2n">
                                <label for="email" class="a2d an a1j a1R a2u dark:aT">
                                    Confirm Password
                                </label>
                                <input type="password" name="cpass" placeholder="Enter Confirm Password" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" />
                            </div>
                            <div class="a2a">
