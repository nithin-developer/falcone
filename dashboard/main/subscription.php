                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xl-12 col-12">
                                        ...
                                        <center>
                                            ...
                                            <div class="col-5 mt-4">
                                                ...
                                                ?>
                                                    ...
                                                    <h5><i>Your Referral Code : <?php echo $row['referral_code'] ?></i></h5>
                                            </div>
                                        <?php } ?>
                                        </center>
                                    </div>
                            ...
                            <div class="col-xl-12 col-12 mt-30">
                                <div class="box">
                                    <div class="box-header with-border">
                                        <h4 class="box-title">Your Referrals</h4>
                                    </div>
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <table class="table no-margin table-hover">
                                                ...
                                                $sql2 = "SELECT * FROM users WHERE referred_by = '$code'";
