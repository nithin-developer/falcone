...
try {
    $user = $kite->generateSession($request, "fxbcx6pligh3mgbtltmct4ult5ex0d8j");
    $kite->setAccessToken($user->access_token);
} catch (Exception $e) {
    echo "<script>alert('Authentication failed: " . $e->getMessage() . "')</script>";
    throw $e;
}
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            ?>
                                                <div class="no-line-chart d-flex align-items-end justify-content-between">
                                                    <div>
                                                        <h4>NIFTY 50</h4>
                                                        <h4 class="text-success">17.854.05 (+243.65)<?php echo $row['referral_bonus'] ?></h4>
                                                    </div>
                                                    <div class="text-success mdi mdi-arrow-up-circle-outline mdi-48px"></div>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12 col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h4 class="box-title">Hey <?php echo $name ?>, Welcome !</h4>
                                </div>
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <center>
                                            <img src="https://img.freepik.com/premium-vector/megaphone-with-referral-program-speech-bubble-banner-loudspeaker-label-business-marketing-advertising-vector-isolated-background-eps-10_399089-2038.jpg?w=2000" class="rounded-circle mt-4" width="20%">
                                            <h3 class="mt-3">Referral Program was Introduced</h3>
                                            <div class="col-5 mt-4">
                                                <p>Now, we introduce the referral program for increase the community and offering the 10$ per Successful referral and that amount will add to your Investments after they invest on any slot you will get the bonus</p>
                                            </div>
                                        </center>
                                    </div>
                                </div>
