...
if (isset($_POST['submit'])) {
  ...
  if (!$result->num_rows > 0) {
    ...
    $sql = "INSERT INTO users (Name, Email, Password, referral_code, referred_by) VALUES ('$name','$email','$pass','$code','$referral')";
    $result = mysqli_query($link, $sql);
    if(!empty($referral)){
      $sql = "update users
      set referral_bonus = referral_bonus + 10
      where referral_code = '$referral'";
      $result = mysqli_query($link, $sql);
    }
    if ($result) {
      echo "<script> alert('User Registration Successfull. Now you can Sign in');</script>";
          ...
          <div class="wow fadeInUp a3r aH[500px] a1X a1C a2l[#f5f5f5] a1 a2P dark:a4E dark:a3 sm:a4j[60px]" data-wow-delay="0s">
            ...
            <form method="POST">
              <div class="a2n">
                ...
                <input required type="text" name="name" placeholder="Enter your full name" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" />
              </div>
              <div class="a2n">
                <label for="email" class="a2d an a1j a1R a2u dark:aT">
                  Work Email
                </label>
                <input required type="email" name="email" placeholder="Enter your Email" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" />
              </div>
              <div class="a2n">
                <label for="password" class="a2d an a1j a1R a2u dark:aT">
                  Your Password
                </label>
                <input required type="password" name="password" placeholder="Enter your Password" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" />
              </div>
              <div class="a2n">
                <label for="password" class="a2d an a1j a1R a2u dark:aT">
                  Referral Code (optional)
                </label>
                <input type="number" name="referral" placeholder="Enter Referral Code" class="a4F dark:a38 ab a1u a1C a27 a4z a22 aI a1F aS a4I a24 focus:a1H focus-visible:aM dark:a4G dark:a1w[#1F2656]" />
              </div>
              <div class="a2n aa">
            ...
            <p class="a2G a1F a1R aQ dark:aS">
              ...
              <a href="signin.php" class="aR hover:a2z">
                Sign in
              </a>
            </p>
          </div>
...
<!-- Mirrored from crypto-tailwind.preview.uideck.com/signup by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Sep 2022 12:39:30 GMT -->
